...
### Automation: remind yourself if any downstairs window is still open at bedtime

At bedtime, a reminder can help you catch an open window before you lock up for the night.
...
### Automation: turn off the heater if the roof window has been open for 10 minutes
