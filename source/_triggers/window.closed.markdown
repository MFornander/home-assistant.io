...
The **Window closed** trigger fires when a targeted window closes. Use it to restore heating after airing out a room, confirm that windows are shut before bedtime, or continue an automation only after a window has stayed closed for a while.
...
### Automation: turn the heating back on when the bedroom window has been closed for 2 minutes
...
### Automation: lock the patio door after all ground-floor windows are closed
